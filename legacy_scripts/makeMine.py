...
include_1_filename = (camera_name + "_1.inc")
include_2_filename = (camera_name + "_2.inc")
include_3_filename = (camera_name + "_3.inc")
include_4_filename = (camera_name + "_4.inc")
