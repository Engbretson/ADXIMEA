...
class epicsShareClass MC023CG : public ADDriver {
public:
    static const char *notAvailable;
    static const char *driverName;
    
    MC023CG(const char *portName, int maxBuffers, size_t maxMemory, int priority, int stackSize, const char *id);
    ~MC023CG();
    ...
    void MC023CGHandleNewImageTask(void);
...
#define FIRST_MC023CG_PARAM GC_S_DeviceVendorName
#define LAST_MC023CG_PARAM GC_I_PayloadSize; 

};

#define NUM_MC023CG_PARAMS LAST_MC023CG_PARAM - FIRST_MC023CG_PARAM +1
