...
#define	MV40_DLL_VERSION_LOW 18
#define	MV40_DLL_VERSION_COMPILE 2
...
#define	MV40_SYS_VERSION_COMPILE	33
...
#define	MQ_SYS_VERSION_COMPILE		8
...
#define	API_INST_PACKAGE_VERSION_LOW 18
#define	API_INST_PACKAGE_COMPILE 02

#define STRINGIFY(x) #x
#define TOSTRING(x) STRINGIFY(x)
#define API_INST_PACKAGE_VERSION_STRING "V" TOSTRING(API_INST_PACKAGE_VERSION_HIGH) "." TOSTRING(API_INST_PACKAGE_VERSION_LOW) "." TOSTRING(API_INST_PACKAGE_COMPILE) ".00"
