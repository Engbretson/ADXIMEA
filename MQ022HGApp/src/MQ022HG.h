...
class epicsShareClass MQ022HG : public ADDriver {
public:
    static const char *notAvailable;
    static const char *driverName;
    
    MQ022HG(const char *portName, int maxBuffers, size_t maxMemory, int priority, int stackSize, const char *id);
    ~MQ022HG();
    ...
    void MQ022HGHandleNewImageTask(void);
...
#define FIRST_MQ022HG_PARAM GC_exposure
#define LAST_MQ022HG_PARAMint GC_transport_pixel_format; 

};

#define NUM_MQ022HG_PARAMS LAST_MQ022HG_PARAM - FIRST_MQ022HG_PARAM +1
